  ...
  public  class Donnees_Dossiers
    {
        ...
        public Nullable<int>    dossier_clot { get; set; } = 0;
        public Nullable<int>    dossier_etat_rapport { get; set; }
        ...
        public Nullable<int>    rapport_amiante_FCFP { get; set; }
        public Nullable<int>    rapport_amiante_Autres { get; set; }
        public Nullable<int>    rapport_termites_resultat { get; set; }
        ...
        public Nullable<int>    facturation_restante { get; set; } 
        public string facturation_compte_client { get; set; } = "";
        public Nullable<int>    facturation_remise_globale { get; set; } 
        ...
        public Nullable<int>    Date_RDV { get; set; }
        public Nullable<int>    Facture_validation { get; set; }
        public Nullable<int>    Paiement_validation { get; set; }
        ...
        public Nullable<int>    DATE_RDV_facture { get; set; }
        public Nullable<int>    Date_paiement_codee { get; set; }
        ...
        public Nullable<int>    date_derniere_sauvegarde { get; set; }
        public Nullable<int> MySqlid { get; set; } = 0;
    }
}
